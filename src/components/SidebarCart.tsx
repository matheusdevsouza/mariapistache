          ...
          >
                      ...
                      <>
                        <ul className="space-y-4">
                          {state.items.map(item => (
                            <li key={item.product.id} className="bg-white/90 border border-sage-200/60 rounded-xl p-4 flex gap-4 items-center hover:border-primary-300 transition-all duration-300 ease-out shadow-sm">
                          ...
                          <div className="space-y-3">
                            {shippingOptions.slice(0, 4).map((option, index) => (
                              <motion.button
                                ...
                                className={`w-full text-left p-4 rounded-xl border-2 transition-all duration-200 relative overflow-hidden ${selectedOption?.id === option.id
                                ...
                                <div className="relative flex items-start justify-between gap-4">
                                  <div className="flex-1 min-w-0">
                                    <div className="flex items-center gap-3 mb-2">
                                      <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center flex-shrink-0 transition-all ${selectedOption?.id === option.id
                                      ...
                                      <span className={`font-bold text-base ${selectedOption?.id === option.id ? 'text-primary-700' : 'text-sage-900'
                                        }`}>
                                        {option.company}
                                      </span>
                                    </div>
                                  ...
                                  <div className="flex-shrink-0">
                                    <div className={`text-right font-extrabold text-xl ${selectedOption?.id === option.id ? 'text-primary-600' : 'text-sage-900'
                                      }`}>
            ...
            <div className="border-t border-cloud-100 px-6 py-5 bg-sage-50 z-[300]">
              ...
              <button
                ...
                className={`w-full py-3 px-6 rounded-xl font-semibold transition-all ${canProceedToCheckout
